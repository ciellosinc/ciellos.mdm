...
# See also https://github.com/ciellosinc/ciellos.mdm/wiki/Building-tools
$path = "$PSScriptRoot\.."

Import-Module "$path\ciellos.mdm" -Force

Remove-Item -Path "$path\docs\*.md"
$null = New-MarkdownHelp -Module ciellos.mdm -OutputFolder "$path\docs" -Force
