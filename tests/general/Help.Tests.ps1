...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ciellos.mdm\functions", "$global:testroot\..\ciellos.mdm\internal\functions"),
	
	[string]
	$ModuleName = "ciellos.mdm",
...
$CommandPath = @(
    "$global:testroot\..\ciellos.mdm\functions"
    "$global:testroot\..\ciellos.mdm\internal\functions"
)
