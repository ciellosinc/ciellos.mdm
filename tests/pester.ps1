...
Remove-Module ciellos.mdm -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ciellos.mdm\ciellos.mdm.psd1"
Import-Module "$PSScriptRoot\..\ciellos.mdm\ciellos.mdm.psm1" -Force
